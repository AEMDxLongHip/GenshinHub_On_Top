print("https://discord.com/invite/zE6fjcxk")
toclipboard("https://discord.com/invite/zE6fjcxk")
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Genshin Hub") then
			makefolder("Genshin Hub")
		end
		if not isfolder("Genshin Hub") then
			makefolder("Genshin Hub")
		end
		if not isfile("Genshin Hub" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Genshin Hub .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Genshin Hub" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Genshin Hub" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Genshin Hub" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
if QuestC.Visible == true then
						...
						local Tab2 = Main.create("Player/Stack")
						
						local Tab3 = Main.create("Raids/Warp")
